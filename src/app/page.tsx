...
import { AchLedgerConsole } from '@/components/AchLedgerConsole';
import { PostgresIndexingConsole } from '@/components/PostgresIndexingConsole';
import { QueueWorkerSimulator } from '@/components/QueueWorkerSimulator';
...
export default function HomePage() {
  ...
  useEffect(() => {
    const sectionIds = ['briefing', 'metrics', 'payments', 'postgres', 'queues', 'roi', 'blueprints'];
    ...
    <div className="min-h-screen bg-[var(--color-canvas)] text-[var(--color-text-primary)]">
      ...
      <main className="w-full max-w-full min-w-0 overflow-x-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 space-y-8">
          ...
          <section id="postgres" className="scroll-mt-20">
            <PostgresIndexingConsole />
          </section>

          <section id="queues" className="scroll-mt-20">
            <QueueWorkerSimulator />
          </section>
